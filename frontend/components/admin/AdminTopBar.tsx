...
export default function AdminTopBar(props: { adminName: string; adminEmail: string }) {
  return (
    <Suspense fallback={<header className="sticky top-0 z-50 bg-white border-b border-slate-200 px-6 py-[26px] flex items-center justify-between gap-4 flex-shrink-0" />}>
      <AdminTopBarContent {...props} />
    </Suspense>
  );
}
