    ...
    async function handleSave() {
        ...
        try {
            ...
            if (avatarFile) {
                ...
                const { data: upData } = await api.post("/api/upload/avatar", fd, {
                    headers: { "Content-Type": "multipart/form-data" },
                })
                avatarUrl = upData.data?.url ?? upData.data?.path ?? upData.url
    ...
    return (
        <main className="flex-1 p-6 overflow-y-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1">Manage your admin profile and account information.</p>
            </div>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-6">
                    ...
                    <div className="flex items-start gap-6 mb-6 pb-6 border-b border-slate-100">
                        ...
                        <div className="flex-1 pt-1">
                            <p className="text-sm font-semibold text-slate-900 mb-1">{fullName || "Admin"}</p>
                            <p className="text-sm text-slate-500 mb-3">{form.email}</p>
                            <p className="text-xs text-slate-400">Upload a square profile photo in JPG, JPEG, or PNG format.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={form.email}
                                    disabled
                                    className="w-full px-3.5 py-2.5 border border-slate-200 rounded-xl text-sm text-slate-400 bg-slate-50 outline-none cursor-not-allowed"
                                />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <button
                                onClick={handleSave}
                                disabled={saving}
                                className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-700 transition-colors shadow-sm shadow-indigo-500/20 disabled:opacity-70"
                            >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <button
                                ...
                                disabled={pwSaving}
                                className="flex items-center gap-2 px-5 py-2.5 bg-slate-800 text-white rounded-xl text-sm font-semibold hover:bg-slate-900 transition-colors shadow-sm disabled:opacity-70"
                            >
