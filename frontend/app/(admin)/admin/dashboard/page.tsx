...
export default function AdminDashboardPage() {
  ...
  return (
    <main className="flex-1 p-6 space-y-8">
      ...
      {/* Users */}
      <div>
        <SectionTitle title="Users" sub="Registered students and teachers and overall activity" />
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          <StatCard icon={Users}     label="Total Students"           value={fmt(stats.totalUsers)}    sub="All registered users"        iconBg="bg-indigo-50"  iconColor="text-indigo-600" onClick={() => router.push("/admin/users")} />
          <StatCard icon={UserCheck} label="Active Students"          value={fmt(stats.activeUsers)}   sub="Non-banned accounts"         iconBg="bg-emerald-50" iconColor="text-emerald-600" onClick={() => router.push("/admin/users?tab=ACTIVE")} />
