...
export default function StudentLeaderboardClient() {
  ...
  const rankEntry = ranking.find((r) => r.student.id === MOCK_STUDENT_ID);
  ...
  return (
    <div className="p-6 space-y-6">
      {/* SECTION 1 — Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-800">My Leaderboard Standing</h1>
        <p className="text-sm text-slate-500 mt-1">Class 8 — Your Rank &amp; Full Report</p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
          ...
          <div className="flex-shrink-0 text-center sm:text-left">
            ...
            <p className="text-6xl font-extrabold text-indigo-600 mt-1">#{rank}</p>
            <p className="text-sm text-slate-400 mt-1">out of {totalStudents} students</p>
          </div>
      ...
      {/* SECTION 4 — Performance Trend (Line Chart) */}
      ...
      {/* SECTION 5 — Subject Breakdown (Bar Chart) */}
      <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm">
      ...
      {/* SECTION 6 — Detailed Marks Tables (one per term) */}
