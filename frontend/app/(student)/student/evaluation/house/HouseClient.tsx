...
const BASE_PATH = "/student/evaluation/house";
...
export default function StudentHouseClient() {
  ...
  const currentStudent = getStudentById(STUDENT_ID);
  const myHouse = currentStudent.house;
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {standings.map((standing) => {
          const isMyHouse = standing.house === myHouse;
          return (
            <div
              key={standing.house}
            ...
            >
              ...
              {isMyHouse ? (
                ...
                <button
                  disabled
                  className="w-full px-4 py-2 text-sm font-semibold text-slate-400 bg-slate-100 rounded-xl cursor-not-allowed flex items-center justify-center gap-2"
                >
