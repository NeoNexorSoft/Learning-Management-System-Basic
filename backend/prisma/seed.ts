          ...
          lessons: [
            {
              ...
              video_url: "https://example.com/react-intro",
              duration: 1800,
            },
            {
              title: "JSX and Components",
              type: LessonType.VIDEO,
              video_url: "https://example.com/jsx",
              duration: 2100,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/useeffect",
              duration: 2400,
            },
            {
              title: "Context API",
              type: LessonType.VIDEO,
              video_url: "https://example.com/context",
              duration: 1800,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/performance",
              duration: 2700,
            },
            {
              title: "Testing React Apps",
              type: LessonType.VIDEO,
              video_url: "https://example.com/testing",
              duration: 2100,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/node-intro",
              duration: 1800,
            },
            {
              title: "Express Routing",
              type: LessonType.VIDEO,
              video_url: "https://example.com/express-routing",
              duration: 2100,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/jwt",
              duration: 2400,
            },
            {
              title: "Password Hashing with bcrypt",
              type: LessonType.VIDEO,
              video_url: "https://example.com/bcrypt",
              duration: 1200,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/numpy",
              duration: 1500,
            },
            {
              title: "Pandas DataFrames",
              type: LessonType.VIDEO,
              video_url: "https://example.com/pandas",
              duration: 2400,
            },
            {
          ...
          lessons: [
            {
              ...
              type: LessonType.VIDEO,
              video_url: "https://example.com/matplotlib",
              duration: 1800,
            },
            {
              title: "Seaborn for Statistical Plots",
              type: LessonType.VIDEO,
              video_url: "https://example.com/seaborn",
              duration: 1500,
            },
            {
